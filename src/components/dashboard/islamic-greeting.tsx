  ...
  const getGreetingConfig = (): GreetingConfig => {
    ...
    if (hour >= 5 && hour < 12) {
      ...
      return {
        ...
        phraseTranslation: 'O Allah, help me to remember You, thank You, and worship You in the best way'
      };
    } else {
      return {
        ...
        <CardContent className="p-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-1 sm:space-y-0">
                  <div className="arabic-text text-lg text-gray-700">
          ...
          >
            <div className="text-center">
              <div className="arabic-text text-xl text-gray-800 mb-2">
                {config.arabicPhrase}
              </div>
              <div className="text-sm text-gray-600 italic">
                {config.phraseTranslation}
              </div>
            </div>
          </motion.div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-4 pt-4 border-t border-white/30">
            <div className="flex items-center space-x-4 text-sm text-gray-600">
              <div className="flex items-center space-x-1">
                ...
                <span>{currentTime.toLocaleDateString('en', { 
                  weekday: 'long',
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
